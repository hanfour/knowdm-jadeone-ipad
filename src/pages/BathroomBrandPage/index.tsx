...
const masterBathroomItems: EquipmentItem[] = [
  {
    ...
    brand: 'TOTO 全自動馬桶',
    brandColor: '#1a5276',
    image: '/images/bathroom/master/toiletG5.webp',
  ...
  },
  {
    ...
    brandColor: '#000',
    image: '/images/bathroom/master/mirror-cabinet.webp',
    description: '',
    features: [
      '發泡材質,防潮防水性優異',
      '鏡+收納二合一,完美整合功能與美觀',
  ...
  },
  {
    ...
    brandColor: '#000',
    image: '/images/bathroom/master/vanity.webp',
    features: [
      '發泡材質,防潮防水性優異',
      '搭配TOTO瓷盆耐用好清潔',
      '櫃體設計收納方便',
  ...
  },
  {
    ...
    brand: '國際牌浴室暖風機',
    brandColor: '#000',
    image: '/images/bathroom/master/heater.webp',
    features: [
      '高效換氣、暖風、涼風、乾燥四合一功能',
      'DC馬達',
      '5重安全裝置',
  ...
  },
  {
    ...
    name: '臉盆用單槍龍頭',
    brand: '',
    image: '/images/bathroom/master/basin-faucet.webp',
    features: [],
    clickable: false,
  },
  {
    ...
    name: '淋浴用單槍龍頭',
    brand: '',
    image: '/images/bathroom/master/shower-faucet.webp',
    features: [],
    clickable: false,
  },
  {
    ...
    name: '滑桿組',
    brand: '',
    image: '/images/bathroom/master/slide-bar.webp',
    features: [],
    clickable: false,
  },
  {
    ...
    name: '雙層毛巾架',
    brand: '',
    image: '/images/bathroom/master/towel-rack.webp',
    features: [],
    clickable: false,
  },
];
...
const guestBathroomItems: EquipmentItem[] = [
  {
    ...
    brand: 'TOTO 單體馬桶',
    brandColor: '#1a5276',
    image: '/images/bathroom/guest/toilet.webp',
  ...
  },
  {
    ...
    brandColor: '#000',
    image: '/images/bathroom/guest/mirror-cabinet.webp',
    description: '',
    features: [
      '發泡材質,防潮防水性優異',
      '鏡+收納二合一,完美整合功能與美觀',
  ...
  },
  {
    ...
    brandColor: '#000',
    image: '/images/bathroom/guest/vanity.webp',
    features: [
      '發泡材質,防潮防水性優異',
      '上方瓷盆耐用好清潔',
      '櫃體設計收納方便',
  ...
  },
  {
    ...
    brand: '國際牌靜音換氣扇',
    brandColor: '#000',
    image: '/images/bathroom/guest/ventilator.webp',
    features: [
      '電容器馬達',
      '風倒流防止裝置',
      '鍍亞鉛防銹鋼板機體',
  ...
  },
  {
    ...
    name: '臉盆用單槍龍頭',
    brand: '',
    image: '/images/bathroom/guest/basin-faucet.webp',
    features: [],
    clickable: false,
  },
  {
    ...
    name: '淋浴用單槍龍頭',
    brand: '',
    image: '/images/bathroom/guest/shower-faucet.webp',
    features: [],
    clickable: false,
  },
  {
    ...
    name: '滑桿組',
    brand: '',
    image: '/images/bathroom/guest/slide-bar.webp',
    features: [],
    clickable: false,
  },
  {
    ...
    name: '雙層毛巾架',
    brand: '',
    image: '/images/bathroom/guest/towel-rack.webp',
    features: [],
    clickable: false,
  },
];
...
const BathroomBrandPage: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-cover bg-center" style={{ backgroundImage: 'url(/images/kitchen/cabinet-bg.webp)' }}>
      {/* 導航列 */}
